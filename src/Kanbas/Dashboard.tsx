                ...
                <div className="row row-cols-1 row-cols-md-5 g-4">
                    ...
                    <div className="wd-dashboard-course col" style={{ width: "300px" }}>
                        <div className="card rounded-3 overflow-hidden">
                            <Link className="wd-dashboard-course-link text-decoration-none text-dark"
                                ...
                                <img src="/images/pic1.jpg" width="100%" height={160} />
                    ...
                    <div className="wd-dashboard-course col" style={{ width: "300px" }}>
                        <div className="card rounded-3 overflow-hidden">
                            <Link className="wd-dashboard-course-link text-decoration-none text-dark"
                                ...
                                <img src="/images/pic2.jpg" width="100%" height={160} />
                                <div className="card-body">
                    ...
                    <div className="wd-dashboard-course col" style={{ width: "300px" }}>
                        <div className="card rounded-3 overflow-hidden">
                            <Link className="wd-dashboard-course-link text-decoration-none text-dark"
                                ...
                                <img src="/images/pic3.jpg" width="100%" height={160} />
                                <div className="card-body">
                    ...
                    <div className="wd-dashboard-course col" style={{ width: "300px" }}>
                        <div className="card rounded-3 overflow-hidden">
                            <Link className="wd-dashboard-course-link text-decoration-none text-dark"
                                ...
                                <img src="/images/pic4.jpg" width="100%" height={160} />
                                <div className="card-body">
                    ...
                    <div className="wd-dashboard-course col" style={{ width: "300px" }}>
                        <div className="card rounded-3 overflow-hidden">
                            <Link className="wd-dashboard-course-link text-decoration-none text-dark"
                                ...
                                <img src="/images/pic5.jpg" width="100%" height={160} />
                                <div className="card-body">
                    ...
                    <div className="wd-dashboard-course col" style={{ width: "300px" }}>
                        <div className="card rounded-3 overflow-hidden">
                            <Link className="wd-dashboard-course-link text-decoration-none text-dark"
                                ...
                                <img src="/images/pic6.jpg" width="100%" height={160} />
                                <div className="card-body">
                    ...
                    <div className="wd-dashboard-course col" style={{ width: "300px" }}>
                        <div className="card rounded-3 overflow-hidden">
                            <Link className="wd-dashboard-course-link text-decoration-none text-dark"
                                ...
                                <img src="/images/pic7.jpg" width="100%" height={160} />
                                <div className="card-body">
                    ...
                    <div className="wd-dashboard-course col" style={{ width: "300px" }}>
                        <div className="card rounded-3 overflow-hidden">
                            <Link className="wd-dashboard-course-link text-decoration-none text-dark"
                                ...
                                <img src="/images/pic8.jpg" width="100%" height={160} />
                                <div className="card-body">
                    ...
                    <div className="wd-dashboard-course col" style={{ width: "300px" }}>
                        <div className="card rounded-3 overflow-hidden">
                            ...
                            <img src="/images/pic9.jpg" width="100%" height={160} />
                            <div className="card-body">
