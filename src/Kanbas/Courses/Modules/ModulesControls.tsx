...
export default function ModulesControls() {
    return (
        <div id="wd-modules-controls" className="text-nowrap">
            <button id="wd-view-progress" className="btn btn-md btn-secondary"> View Progress</button> {" "}
            <button id="wd-collapse-all" className="btn btn-md btn-secondary"> Collapse All </button>
